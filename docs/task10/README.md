...
In the hero section image, I used CSS keyframes and animation to create a dynamic visual effect.

@keyframes is used to define the animation sequence
animation is applied to move the image in a smooth circular motion
The image slightly squeezes using scale() at the end of each cycle
The animation runs in an infinite loop for continuous motion
